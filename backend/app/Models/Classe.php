...
class Classe extends Model
{
	...
	{
		return $this->belongsToMany(Professeur::class, 'enseigner', 'id_classe',
 'id_professeur')                                                                           ->using(Enseigner::class)
	...
	{
		return $this->belongsToMany(Matiere::class, 'enseigner', 'id_classe', 'i
d_matiere')                                                                                 ->using(Enseigner::class)
